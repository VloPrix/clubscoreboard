...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['password'])) {
    ...
    if ($password == NULL) {
        ...
        $db->query("CREATE TABLE scoreboard_eventperformance ( ID int(11) NOT NULL AUTO_INCREMENT, eventid int(11) NOT NULL, personid int(11) NOT NULL, score int(11) NOT NULL, place text NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB AUTO_INCREMENT=928 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
        // create Events Table
        $db->query("CREATE TABLE scoreboard_events ( ID int(11) NOT NULL AUTO_INCREMENT, name text NOT NULL, date date NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
        // create Member Table
